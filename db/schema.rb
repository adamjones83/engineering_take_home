...
ActiveRecord::Schema[7.2].define(version: 2024_11_27_021752) do
  ...
  create_table "building_custom_fields", force: :cascade do |t|
    ...
    t.index ["client_id"], name: "index_building_custom_fields_on_client_id"
  end
  ...
  add_foreign_key "building_custom_fields", "clients"
